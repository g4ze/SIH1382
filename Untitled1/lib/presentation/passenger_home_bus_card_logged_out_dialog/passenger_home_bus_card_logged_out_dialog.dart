import 'bloc/passenger_home_bus_card_logged_out_bloc.dart';
import 'models/passenger_home_bus_card_logged_out_model.dart';
...
class PassengerHomeBusCardLoggedOutDialog extends StatelessWidget {
  const PassengerHomeBusCardLoggedOutDialog({Key? key}) : super(key: key);

  static Widget builder(BuildContext context) {
    return BlocProvider<PassengerHomeBusCardLoggedOutBloc>(
        create: (context) => PassengerHomeBusCardLoggedOutBloc(
            PassengerHomeBusCardLoggedOutState(
                passengerHomeBusCardLoggedOutModelObj:
                    PassengerHomeBusCardLoggedOutModel()))
          ..add(PassengerHomeBusCardLoggedOutInitialEvent()),
        child: PassengerHomeBusCardLoggedOutDialog());
  }
