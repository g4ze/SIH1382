import 'bloc/driver_home_on_logged_out_one_bloc.dart';
import 'models/driver_home_on_logged_out_one_model.dart';
...
class DriverHomeOnLoggedOutOneScreen extends StatelessWidget {
  const DriverHomeOnLoggedOutOneScreen({Key? key}) : super(key: key);

  static Widget builder(BuildContext context) {
    return BlocProvider<DriverHomeOnLoggedOutOneBloc>(
        create: (context) => DriverHomeOnLoggedOutOneBloc(
            DriverHomeOnLoggedOutOneState(
                driverHomeOnLoggedOutOneModelObj:
                    DriverHomeOnLoggedOutOneModel()))
          ..add(DriverHomeOnLoggedOutOneInitialEvent()),
        child: DriverHomeOnLoggedOutOneScreen());
  }
                    ...
                    children: [
                      ...
                      Padding(
                          ...
                          child: Row(children: [
                            ...
                            BlocSelector<DriverHomeOnLoggedOutOneBloc,
                                    DriverHomeOnLoggedOutOneState, bool?>(
