import 'bloc/login_page_driver_bloc.dart';
import 'models/login_page_driver_model.dart';
...
class LoginPageDriverScreen extends StatelessWidget {
  LoginPageDriverScreen({Key? key}) : super(key: key);

  GlobalKey<FormState> _formKey = GlobalKey<FormState>();

  static Widget builder(BuildContext context) {
    return BlocProvider<LoginPageDriverBloc>(
        create: (context) => LoginPageDriverBloc(LoginPageDriverState(
            loginPageDriverModelObj: LoginPageDriverModel()))
          ..add(LoginPageDriverInitialEvent()),
        child: LoginPageDriverScreen());
  }
            ...
            body: Form(
                ...
                child: SizedBox(
                    ...
                    child: Column(children: [
                      ...
                      BlocSelector<LoginPageDriverBloc, LoginPageDriverState,
